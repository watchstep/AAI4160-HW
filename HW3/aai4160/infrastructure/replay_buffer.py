...
class ReplayBuffer:
    ...
    def sample(self, batch_size):
        ...
        return {
            "obs": self.observations[rand_indices],
            "action": self.actions[rand_indices],
            "reward": self.rewards[rand_indices],
            "next_obs": self.next_observations[rand_indices],
...
class MemoryEfficientReplayBuffer:
    ...
    def sample(self, batch_size):
        ...
        return {
            "obs": self.framebuffer[observation_framebuffer_idcs],
            "action": self.actions[rand_indices],
            "reward": self.rewards[rand_indices],
            "next_obs": self.framebuffer[next_observation_framebuffer_idcs],
            "done": self.dones[rand_indices],
        }
